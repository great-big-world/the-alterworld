...
public class TheAlterworldItems {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(entries -> {
            entries.addAfter(Items.REINFORCED_DEEPSLATE, ANCIENT_MOSAIC.getDefaultStack(), ANCIENT_BRICKS.getDefaultStack(), ANCIENT_BRICK_STAIRS.getDefaultStack(), ANCIENT_BRICK_SLAB.getDefaultStack(), ANCIENT_BRICK_WALL.getDefaultStack());
        });
    }
}
