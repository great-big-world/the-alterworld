...
public class TheAlterworldBlocks {
    ...
    public static void register() {
        ...
        ANCIENT_MOSAIC = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "ancient_mosaic"), AncientMosaicBlock::new, AbstractBlock.Settings.copy(Blocks.END_STONE).mapColor(MapColor.TERRACOTTA_GREEN));
        ANCIENT_BRICKS = RegistryHelper.registerBlock(Identifier.of(GreatBigWorld.NAMESPACE, "ancient_bricks"), AbstractBlock.Settings.copy(Blocks.END_STONE).mapColor(MapColor.TERRACOTTA_GREEN));
