...
public abstract class CowMixin extends AbstractCow {
    ...
    private Optional<Holder.Reference<CowVariant>> gbw$defaultVariantInOverworld(SpawnContext spawnContext, ResourceKey<Registry<CowVariant>> resourceKey, Operation<Optional<Holder.Reference<CowVariant>>> original, @Local(argsOnly = true) EntitySpawnReason entitySpawnReason) {
